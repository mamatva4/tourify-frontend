          ...
          <h5 className='contact'>Contact</h5>
            ...
            <ListGroup className='footer-quick-links'>
              <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
                ...
                <p className='mb-0'>mamatva04@gmail.com</p>
              </ListGroupItem>
            </ListGroup>
            ...
            <ListGroup className='footer-quick-links'>
              <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
                ...
                <p className='mb-0'>+91-8982603242</p>
              </ListGroupItem>
            </ListGroup>
          </Col>

          <Col lg='12' className='text-center pt-5'>
            <p className='copyright'>&#169; {year}, designed and developed by Mamatva. All rights reserved.</p>
          </Col>
        </Row>
      </Container>
    </footer>
